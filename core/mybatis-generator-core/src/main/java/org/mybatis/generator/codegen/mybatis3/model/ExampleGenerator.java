...
public class ExampleGenerator extends AbstractJavaGenerator {
    ...
    private String getCustomExamplePackage(String oldType){
    	 // String examplePackage = ShellRunner.EXAMPLE_MODEL_PACKAGE;
    	 String examplePackage = CustomClassGenerator.basePackage + ".example";
    	 
    	 String[] strings = oldType.split("[.]");
    	 String typeShortName = strings[strings.length-1];
    	 
    	 return examplePackage + "." + typeShortName;
    }
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        //重置Example类型
        introspectedTable.setExampleType(this.getCustomExamplePackage(introspectedTable.getExampleType()));
