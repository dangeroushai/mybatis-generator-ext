...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.CustomElementGenerator;
...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        // 使用扩展的命名空间
        String extNamespace = CustomClassGenerator.extMapperPackage + namespace.substring(namespace.lastIndexOf(".")).replace("Mapper", "ExtMapper");
        answer.addAttribute(new Attribute("namespace", extNamespace));
        ...
        //添加自定义扩展元素
        addCustomExtensionElement(answer);
     ...
     * @param parentElement
     */
    protected void addCustomExtensionElement(XmlElement parentElement) {
		AbstractXmlElementGenerator elementGenerator = new CustomElementGenerator(false);
		initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
